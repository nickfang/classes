...
#<img src="project/images/p430_flips.gif" alt="p430_flips.gif" />
#Let E(N, M) be the expected number of disks that show their white side after M turns.
#We can verify that E(3, 1) = 10/9, E(3, 2) = 5/3, E(10, 4) â&permil;&circ; 5.157 and E(100, 10) â&permil;&circ; 51.893.
#Find E(10^10, 4000).
