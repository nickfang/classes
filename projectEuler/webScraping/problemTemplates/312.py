# Cyclic paths on SierpiĹ&bdquo;ski graphs

#
#- A SierpiĹ&bdquo;ski graph of order-1 (S1) is an equilateral triangle.
#- Sn+1 is obtained from Sn by positioning three copies of Sn so that every pair of copies has one common corner.
#
#<img src="project/images/p312_sierpinskyAt.gif" alt="p312_sierpinskyAt.gif" />
...
#
#<img src="project/images/p312_sierpinsky8t.gif" alt="p312_sierpinsky8t.gif" />
