...
#Each number (question) we ask, we get one of three possible answers:<ul><li> "Your guess is lower than the hidden number" (and you incur a cost of a), or</li>
#<li> "Your guess is higher than the hidden number" (and you incur a cost of b), or</li>
#<li> "Yes, that's it!" (and the game ends).</li>
#</ul>Given the value of n, a, and b, an optimal strategy minimizes the total cost for the worst possible case.
