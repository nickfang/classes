...
#<ul><li>a+bi = dn-1(i-1)n-1 + dn-2(i-1)n-2 + ... + d1(i-1) + d0</li>
#<li>Each dk is in {0,1}</li>
#<li>There are no leading zeroes, i.e. dn-1 ≠ 0, unless a+bi is itself 0</li>
#</ul>Here are base i-1 representations of a few Gaussian integers:
