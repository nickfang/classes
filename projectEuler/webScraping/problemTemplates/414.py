...
#<ul><li> 0 if i = Cb or if i written in base b consists of 5 identical digits
#</li><li> the number of iterations it takes the Kaprekar routine in base b to arrive at Cb, otherwise
#</li></ul>
