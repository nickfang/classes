...
#
#
#You are given:C(3, 1) = {(3, 0), (-1, 2), (-1,0), (-1,-2)}C(2500, 1000) =<ul><li>
# {(2500, 0), (772, 2376), (772, -2376), (516, 1792),
# (516, -1792), (500, 0), (68, 504), (68, -504),(-1356, 1088), (-1356, -1088), (-1500, 1000), (-1500, -1000)}</li></ul>Note: (-625, 0) is not an element of C(2500, 1000) because $\sin(t)$ is not a rational number for the corresponding values of t.
#
