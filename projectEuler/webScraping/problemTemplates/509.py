...
#They may only take a number of stones from a pile that is a proper divisor (a proper divisor of n is a divisor of n smaller than n) of the number of stones present in the pile. E.g. if a pile at a certain moment contains 24 stones they may take only 1,2,3,4,6,8 or 12 stones from that pile.
...
#Let S(n) be the number of winning positions for the next player for 1 â&permil;¤ a, b, c â&permil;¤ n.S(10) = 692 and S(100) = 735494.
#
