...
#<img src="project/images/p300_protein.gif" alt="p300_protein.gif" />
...
#Assuming that H and P elements are equally likely to occur in any position along the string, the average number of H-H contact points in an optimal folding of a random protein string of length 8 turns out to be 850Â /Â 28=3.3203125.
