...
#
#A geoboard (of order N) is a square board with equally-spaced pins protruding from the surface, representing an integer point lattice for coordinates 0 â&permil;¤ x,y â&permil;¤ N.
...
#<img src="project/images/p514_geoboard.png" alt="p514_geoboard.png" />
