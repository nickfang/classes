...
#Point P, also with integer coordinates, is chosen on the line AC so that the three triangles ABP, CDP and BDP are all similar (Have equal angles).
#<img src="project/images/p299_ThreeSimTri.gif" alt="p299_ThreeSimTri.gif" />
