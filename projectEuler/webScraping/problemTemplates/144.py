...
#The specific white cell we will be considering is an ellipse with the equation 4x^2 + y2 = 100
#The section corresponding to −0.01 ≤ x ≤ +0.01 at the top is missing, allowing the light to enter and exit through the hole.
#<img src="project/images/p144_1.gif" width="268" height="240" alt="" /><img src="project/images/p144_2.gif" width="141" height="287" alt="" />
