...
#
#The grid graphs embedded in the Euclidean plane are not rigid, as the following animation demonstrates:<img src="project/images/p434_rigid.gif" alt="p434_rigid.gif" />
#However, one can make them rigid by adding diagonal edges to the cells. For example, for the 2x3 grid graph, there are 19 ways to make the graph rigid:<img src="project/images/p434_rigid23.png" alt="p434_rigid23.png" />
