...
#Each number (question) we ask, has a cost equal to the number asked and we get one of three possible answers:<ul><li> "Your guess is lower than the hidden number", or</li>
#<li> "Yes, that's it!", or</li>
#<li> "Your guess is higher than the hidden number".</li>
#</ul>Given the value of n, an optimal strategy minimizes the total cost (i.e. the sum of all the questions asked) for the worst possible case. E.g.
...
#Similarly, C(100) = 400 and <img style="vertical-align:middle;" src="project/images/p328_sum1.gif" alt="p328_sum1.gif" />C(n) = 17575.
#Find <img style="vertical-align:middle;" src="project/images/p328_sum2.gif" alt="p328_sum2.gif" />C(n).
#
