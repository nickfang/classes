...
#<ul><li> g1 = n
#</li><li> for k &gt; 1, gk is obtained by writing gk-1 in base k, interpreting it as a base k + 1 number, and subtracting 1.
#</li></ul>
...
#<ul><li> g1 = 6.
#</li><li> g2 = 11 since 6 = 1102, 1103 = 12, and 12 - 1 = 11.
#</li><li> g3 = 17 since 11 = 1023, 1024 = 18, and 18 - 1 = 17.
#</li><li> g4 = 25 since 17 = 1014, 1015 = 26, and 26 - 1 = 25.
#</li></ul>
#and so on.
#
#
