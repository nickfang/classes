# bst property.  Keys less than parent go left and keys more than parent go right
...
class TreeNode:
	...
	def isLeftChild(self):
		return self.parent and self.parentleftChild == self

	def isRightChild(self):
		return self.parent and self.parentRightChild == self
...
class BinarySearchTree:
	...
	def _put(sel, key, val, currentNode):
		if key < currentNode.key:
			...
			if currentNode.hasRightChild():
				self._put(key, val, curentNode.rightChild)
			else:
	...
	def delete(self, key):
		if self.size > 1:
			...
			if nodeToRemove:
				...
				raise KeyError("Error, key no in tree")
